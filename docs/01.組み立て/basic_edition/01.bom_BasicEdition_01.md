...
|SC001b-BE|![](./img/001bom/SC001b-BE.jpg)|<span style="font-size:13px;">皿ねじ M3x14 4本 + 1本（予備）,ナイロン緩み防止付ナット M3 4個 + 1個（予備）,ロックナット M3 4個 + 1個（予備）</span>|1セット|◯|◯|
...
|ac003|![](./img/001bom/AC003.JPG)|<span style="font-size:14px;">両面テープ20mm</span>|3枚|◯|◯|
