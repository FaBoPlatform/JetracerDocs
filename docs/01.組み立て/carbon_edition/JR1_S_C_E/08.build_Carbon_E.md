# JetRacer Kit Carbon Edition ４GBモデル　組み立て E
...
<strong><span style="color: red; ">※警告　このページのチュートリアルは発売前のモデルでございます。したがってお客様は参照先を間違っている可能性がございます。箱側面の型番をご覧ください。</span></strong>
...
※車体レスモデル（JR1-NV-C-E）は、RCカー本体　TT-02 XBプロは付属しません。
...
中央がねじがある板は上部、長さの目盛がある板は下部となります。
...
ねじ位置を合わせ、車体から取り除いた4本のタッピングビスを使い、ねじ穴が壊れないように仮締めを本締めをします。
...
モバイルバッテリーとロワーパネルを両面テープで接着させます。モバイルバッテリーを中央ではなく片方に寄せます。（モバイルバッテリーの残量ランプを見やすくするため）また、USB Type-Cで充電を行うのでスペーサーと干渉しないように気おつけて取り付けましょう。
...
![](./../../img/img_carbon/E/UpperPannel/Upper_conbine004.JPG)

コントローラー基板をJetson 40Pinヘッダーに取り付けます。ズレて挿入したり、ピンが変形しないように慎重に刺します。

![](./../../img/img_carbon/E/UpperPannel/Upper_conbine005.JPG)

コントローラボードが装着された様子。

![](./../../img/img_carbon/E/UpperPannel/Upper_conbine006.JPG)

受信機とコントロール基板の配線をいたします。受信機のコネクター口を確認します。上から１，２，B（外側が黒）

![](./../../img/img_carbon/E/UpperPannel/Upper_conbine008.JPG)

受信機に3ピンのケーブルをそれぞれ3か所刺します。。極性がありますので間違えないようにしましょう。（外側：黒）サーボとスピードコントローラのコネクタを確認します。スピードコントローラ（スロットル信号　TH）サーボ（ステアリング信号　ST）

![](./../../img/img_carbon/E/UpperPannel/Upper_conbine009.JPG)

次にコントローラ基板の差し込み口を確認します。

※配線接続（極性間違いなど）を間違えると基板損傷する可能性がございますので、間違えないようにご注意願います。受信機とコントローラー基板（１，２，３）ケーブルを接続します。受信機Bはコントローラー基板の3と接続します。ステアリング信号をコントローラーボード基板のSTへ接続、スロットル信号は、THへ接続します。（STコネクタは、両側が１ピン分空きます。）

![](./../../img/img_carbon/E/UpperPannel/Upper_conbine010.JPG)

安全のため、組立てた作業台にRCカーを載せます。

![](./../../img/img_carbon/E/UpperPannel/Upper_conbine011.JPG)
...
RCカー部の電源がOFFになっていることを確認してください。

![](./../../img/img_carbon/E/UpperPannel/Upper_conbine012.JPG)

RCカーとバッテリーを接続します。

![](./../../img/img_carbon/E/UpperPannel/Upper_conbine013.JPG)
...
スピードコントローラーTBLE-04Sの場合は、３線のモーターケーブル（黄色、青色、橙色）、スロットル信号（TH)のケーブルとステアリング信号（ST）のケーブルをそれぞれ結束バンドで束ねます。
...
![](./../../img/img_carbon/E/UpperPannel/Upper_conbine014.JPG)

![](./../../img/img_carbon/E/UpperPannel/Upper_conbine015.JPG)

![](./../../img/img_carbon/E/UpperPannel/Upper_conbine016.JPG)
...
![](./../../img/img_carbon/E/UpperPannel/Upper_conbine021.JPG)

RCカーのスイッチをスライドさせ、RCカーに電源を投入します。

※電源投入時は、特にRCカーの暴走に注意してください。

JetRacerコントロールボードRev2.0.23はRCカーの電源をオンすると橙LEDが点灯します。
