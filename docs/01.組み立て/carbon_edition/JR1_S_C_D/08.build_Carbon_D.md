# JetRacer Kit Carbon Edition ４GBモデル　組み立て D
...
※配線接続を間違えると基板損傷する可能性がございますので、間違えないようにご注意願います。
...
|写真|部品または工具|個数|
|:--|:--|:--:|
|![](./../../img/img_bom/add_cablelock001.jpg){: style="height:210px;width:200px"}|結束バンド|１個（２０２３年１月１０出荷以降は3個）|
...
J側にスイッチをスライドしてください。D側はプロポを使わずゲームパッドで操作するモードになります。（フルカラーLEDが黄色に発光します。）J側でご使用ください。
